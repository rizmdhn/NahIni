    ...
    <div class="container mt-sm-5 my-1">
      <div class="question ml-sm-5 pl-sm-5 pt-2">
        ...
        >
          ...
          <label class="options"
            >2 <input type="radio" name="group-1" value="2"/>
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >3 <input type="radio" name="group-1" value="3" />
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >4 <input type="radio" name="group-1" value="4" />
            <span class="checkmark"></span>
          </label>
    ...
    <div class="container mt-sm-5 my-1">
      <div class="question ml-sm-5 pl-sm-5 pt-2">
        ...
        <label class="options"
          ...
          <label class="options"
            >2 <input type="radio" name="group-2" value="2"/>
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >3 <input type="radio" name="group-2" value="3" />
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >4 <input type="radio" name="group-2" value="4" />
            <span class="checkmark"></span>
          </label>
          <label class="options" >5 
    ...
    <div class="container mt-sm-5 my-1">
      <div class="question ml-sm-5 pl-sm-5 pt-2">
        ...
        <label class="options"
          ...
          <label class="options"
            >2 <input type="radio" name="group-3" value="2"/>
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >3 <input type="radio" name="group-3" value="3" />
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >4 <input type="radio" name="group-3" value="4" />
            <span class="checkmark"></span>
          </label>
          <label class="options" >5 
    ...
    <div class="container mt-sm-5 my-1">
      <div class="question ml-sm-5 pl-sm-5 pt-2">
        ...
        <label class="options"
          ...
          <label class="options"
            >2 <input type="radio" name="group-4" value="2"/>
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >3 <input type="radio" name="group-4" value="3" />
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >4 <input type="radio" name="group-4" value="4" />
            <span class="checkmark"></span>
          </label>
          <label class="options" >5 
    ...
    <div class="container mt-sm-5 my-1">
      <div class="question ml-sm-5 pl-sm-5 pt-2">
        ...
        <label class="options"
          ...
          <label class="options"
            >2 <input type="radio" name="group-5" value="2"/>
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >3 <input type="radio" name="group-5" value="3" />
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >4 <input type="radio" name="group-5" value="4" />
            <span class="checkmark"></span>
          </label>
          <label class="options" >5 
    ...
    <div class="container mt-sm-5 my-1">
      <div class="question ml-sm-5 pl-sm-5 pt-2">
        ...
        <label class="options"
          ...
          <label class="options"
            >2 <input type="radio" name="group-6" value="2"/>
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >3 <input type="radio" name="group-6" value="3" />
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >4 <input type="radio" name="group-6" value="4" />
            <span class="checkmark"></span>
          </label>
          <label class="options" >5 
    ...
    <div class="container mt-sm-5 my-1">
      <div class="question ml-sm-5 pl-sm-5 pt-2">
        ...
        <label class="options"
          ...
          <label class="options"
            >2 <input type="radio" name="group-7" value="2"/>
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >3 <input type="radio" name="group-7" value="3" />
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >4 <input type="radio" name="group-7" value="4" />
            <span class="checkmark"></span>
          </label>
          <label class="options" >5 
    ...
    <div class="container mt-sm-5 my-1">
      <div class="question ml-sm-5 pl-sm-5 pt-2">
        ...
        <label class="options"
          ...
          <label class="options"
            >2 <input type="radio" name="group-8" value="2"/>
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >3 <input type="radio" name="group-8" value="3" />
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >4 <input type="radio" name="group-8" value="4" />
            <span class="checkmark"></span>
          </label>
          <label class="options" >5 
    ...
    <div class="container mt-sm-5 my-1">
      <div class="question ml-sm-5 pl-sm-5 pt-2">
        ...
        <label class="options"
          ...
          <label class="options"
            >2 <input type="radio" name="group-9" value="2"/>
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >3 <input type="radio" name="group-9" value="3" />
            <span class="checkmark"></span>
          </label>
          <label class="options"
            >4 <input type="radio" name="group-9" value="4" />
            <span class="checkmark"></span>
          </label>
          <label class="options" >5 
                ...
                if(!empty($_POST['group-7'])) {
                  if(!empty($_POST['group-8'])) {
                    if(!empty($_POST['group-9'])) {                    
                          array_push($array, $_POST['group-1'], $_POST['group-2'], $_POST['group-3'],  $_POST['group-4']
                      , $_POST['group-5'], $_POST['group-6'],  $_POST['group-7'],  $_POST['group-8'], $_POST['group-9']) ;
